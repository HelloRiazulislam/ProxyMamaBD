                  ...
                  <div key={req.id} className="p-4 rounded-xl border border-gray-100 dark:border-slate-800 bg-gray-50 dark:bg-slate-800/50">
                    ...
                    {req.note && (
                      <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">
                        <span className="font-bold">Your Note:</span> "{req.note}"
                      </p>
                    )}
                    {req.adminComment && (
                      <div className="mt-3 p-3 bg-red-50 dark:bg-red-900/20 border border-red-100 dark:border-red-800/30 rounded-lg">
                        <p className="text-xs font-bold text-red-800 dark:text-red-400 mb-1 flex items-center">
                          <AlertTriangle size={12} className="mr-1" /> Admin Comment:
                        </p>
                        <p className="text-sm text-red-700 dark:text-red-300 italic">"{req.adminComment}"</p>
                      </div>
                    )}
                  </div>
                ))
